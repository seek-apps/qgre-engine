...
from qgre.types import QUALITY_WINDOW_SIZE, GameState, RewardResult
...
def synthetic_reward_results() -> list[RewardResult]:
    ...
    return [
        RewardResult(
            reward=0.85,
            scores={
                "q_format_tags": 1.0, "q_tag_content": 0.9,
                "q_node_in_prompt": 0.8, "q_node_format": 1.0, "q_node_length": 0.9,
                "q_chain_s2_refs_s1": 0.7,
                "q_chain_s3_refs_s2": 0.6, "q_self_consistency": 0.8,
                "q_step4_valid_json": 1.0, "q_step4_has_keys": 1.0,
                "q_existence_correct": 0.5, "q_archetype_correct": 0.0, "q_node_f1": 0.3,
            },
            phase=4,
        ),
        RewardResult(
            reward=0.4,
            scores={
                "q_format_tags": 1.0, "q_tag_content": 1.0,
                "q_node_in_prompt": 0.5, "q_node_format": 0.0, "q_node_length": 0.0,
                "q_chain_s2_refs_s1": 0.0,
                "q_chain_s3_refs_s2": 0.0, "q_self_consistency": 0.0,
                "q_step4_valid_json": 0.0, "q_step4_has_keys": 0.0,
                "q_existence_correct": 0.0, "q_archetype_correct": 0.0, "q_node_f1": 0.0,
            },
            phase=4,
        ),
    ]
...
def known_token_ids() -> list[int]:
    ...
    return [
        # <think> block
        THINK_START, 100, 101, 102, THINK_END,
        # <step1_extraction> (opening tag: < step 1 _ extraction >)
        OPEN_ANGLE, STEP_TOKEN, STEP_1_NUM, 94842, CLOSE_ANGLE,
        # step 1 content
        103, 104, 105,
        # </step1_extraction> (closing tag: </ step 1 _ extraction >)
        CLOSE_SLASH, STEP_TOKEN, STEP_1_NUM, 94842, CLOSE_ANGLE,
        # <step2_shared_context>
        OPEN_ANGLE, STEP_TOKEN, STEP_2_NUM, 20405, 8467, CLOSE_ANGLE,
        # step 2 content
        106, 107,
        # </step2_shared_context>
        CLOSE_SLASH, STEP_TOKEN, STEP_2_NUM, 20405, 8467, CLOSE_ANGLE,
    ]
